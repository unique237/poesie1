...
export const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <Link to='/'><img src={assets.poesie} className='w-36' alt="" /></Link>
            ...
            <div className='group relative'>
                ...
                <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                    <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
                        ...
                        <p className='cursor-pointer hover:text-black'>Déconnnexion</p>
                    </div>
                </div>
            </div>
            <Link to='/cart' className='relative'>
                <img src={assets.cart_icon} alt="" className=' w-5 min-w-5' />
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-rose-500 text-white aspect-square rounded-full text-[8px]'>
                    {getCartCount()}
                </p>
            </Link>
